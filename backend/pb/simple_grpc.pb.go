...
type VariableServiceClient interface {
	SetMyVariable(ctx context.Context, in *SetMyVariableRequest, opts ...grpc.CallOption) (*SetMyVariableResponse, error)
...
func (c *variableServiceClient) SetMyVariable(ctx context.Context, in *SetMyVariableRequest, opts ...grpc.CallOption) (*SetMyVariableResponse, error) {
	out := new(SetMyVariableResponse)
	err := c.cc.Invoke(ctx, "/simple.VariableService/SetMyVariable", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VariableServiceServer interface {
	SetMyVariable(context.Context, *SetMyVariableRequest) (*SetMyVariableResponse, error)
...
func (UnimplementedVariableServiceServer) SetMyVariable(context.Context, *SetMyVariableRequest) (*SetMyVariableResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetMyVariable not implemented")
}
...
func _VariableService_SetMyVariable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetMyVariableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VariableServiceServer).SetMyVariable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple.VariableService/SetMyVariable",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VariableServiceServer).SetMyVariable(ctx, req.(*SetMyVariableRequest))
	}
...
var VariableService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SetMyVariable",
			Handler:    _VariableService_SetMyVariable_Handler,
		},
		{
